...
//           {error && <p className="text-foundations-tertiary font-semibold mt-2">{error}</p>}
...
//         <p className="text-foundations-tertiary">
//           Already have an account?{" "}
//           <Link
//             to="/login"
//             className="text-foundations-secondary hover:text-foundations-hover transition duration-200"
//           >
//             Login
//           </Link>
//         </p>
